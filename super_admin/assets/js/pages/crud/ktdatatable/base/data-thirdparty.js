        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            },
            {
                ...
                template: function() {
                    return '\
                    <div class="dropdown">\
							<a href="javascript:;" class="btn btn-sm btn-clean btn-icon btn-icon-md ml-5" data-toggle="dropdown">\
                                <i class="la la-cog"></i>Options\
                            </a>\
						  	<div class="dropdown-menu dropdown-menu-right">\
						    	<a class="dropdown-item" href="#"><i class="flaticon2-document"></i> &nbsp View Logs</a>\
						    	<a class="dropdown-item" href="#"><i class="la la-leaf"></i> &nbsp Change Status</a>\
						  	</div>\
						</div>\
                ';
                },
